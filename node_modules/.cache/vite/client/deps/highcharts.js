 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        class T {
          ...
          refresh(t3, e3) {
            ...
            if (this.distance = k(C2.tooltipOptions.distance, 16), false === v2) this.hide();
            else {
        ...
        class Q {
          ...
          getContainer() {
            ...
            this.container = u2, this.getChartSize(), c2 === this.chartWidth || (c2 = this.chartWidth, this.styledMode || O(u2, { width: V((_a = e3.style) == null ? void 0 : _a.width, c2 + "px") })), this.containerBox = this.getContainerBox(), this._cursor = u2.style.cursor;
