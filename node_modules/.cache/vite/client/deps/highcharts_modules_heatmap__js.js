      ...
      s(e, "Core/Axis/Color/ColorAxisComposition.js", [e["Core/Color/Color.js"], e["Core/Utilities.js"]], function(t2, e2) {
        ...
        return function(t3) {
          ...
          t3.compose = function(t4, i2, n2, y, C) {
            ...
            }(i2), v.fillSetter = f, v.strokeSetter = x, o(y, "afterGetAllItems", h), o(y, "afterColorizeItem", d), o(y, "afterUpdate", p), r(A, { optionalAxis: "colorAxis", translateColors: g }), r(A.pointClass.prototype, { setVisible: m }), o(C, "afterTranslate", c, { order: 1 }), o(C, "bindAxes", u));
        ...
        let { defaultOptions: n } = o, { series: h } = l, { defined: d, extend: p, fireEvent: c, isArray: u, isNumber: m, merge: g, pick: f, relativeLength: x } = a;
        ...
        class y extends t2 {
          ...
          drawLegendSymbol(t3, e3) {
            let s3 = e3.legendItem || {}, i2 = t3.padding, o2 = t3.options, r2 = this.options.labels, l2 = f(o2.itemDistance, 10), a2 = this.horiz, { width: n2, height: h2 } = this.getSize(), d2 = f(o2.labelPadding, a2 ? 16 : 30);
            this.setLegendColor(), s3.symbol || (s3.symbol = this.chart.renderer.symbol("roundedRect").attr({ r: o2.symbolRadius ?? 3, zIndex: 1 }).add(s3.group)), s3.symbol.attr({ x: 0, y: (t3.baseline || 0) - 11, width: n2, height: h2 }), s3.labelWidth = n2 + i2 + (a2 ? l2 : f(r2.x, r2.distance) + (this.maxLabelLength || 0)), s3.labelHeight = h2 + i2 + (a2 ? d2 : 0);
          }
          setState(t3) {
          ...
          getSeriesExtremes() {
            ...
            for (this.dataMin = 1 / 0, this.dataMax = -1 / 0; a2--; ) {
              if (s3 = (l2 = t3[a2]).colorKey = f(l2.options.colorKey, l2.colorKey, l2.pointValKey, l2.zoneAxis, "y"), o2 = l2.pointArrayMap, r2 = l2[s3 + "Min"] && l2[s3 + "Max"], l2[s3 + "Data"]) e3 = l2[s3 + "Data"];
              else if (o2) {
                if (e3 = [], i2 = o2.indexOf(s3), n2 = l2.yData, i2 >= 0 && n2) for (p2 = 0; p2 < n2.length; p2++) e3.push(f(n2[p2][i2], n2[p2]));
              } else e3 = l2.yData;
          ...
          getDataClassLegendSymbols() {
            let t3;
            let e3 = this, s3 = e3.chart, i2 = e3.legendItem && e3.legendItem.labels || [], o2 = s3.options.legend, l2 = f(o2.valueDecimals, -1), a2 = f(o2.valueSuffix, ""), n2 = (t4) => e3.series.reduce((e4, s4) => (e4.push(...s4.points.filter((e5) => e5.dataClass === t4)), e4), []);
            return i2.length || e3.dataClasses.forEach((o3, h2) => {
              let d2 = o3.from, u2 = o3.to, { numberFormatter: m2 } = s3, g2 = true;
          ...
          getSize() {
            ...
            return { width: f(d(i2) ? x(i2, t3.chartWidth) : void 0, o2 == null ? void 0 : o2.symbolWidth, e3 ? y.defaultLegendLength : 12), height: f(d(s3) ? x(s3, t3.chartHeight) : void 0, o2 == null ? void 0 : o2.symbolHeight, e3 ? 12 : y.defaultLegendLength) };
          }
        }
        ...
        let { series: n, seriesTypes: { column: h, scatter: d } } = o, { prototype: { symbols: p } } = r, { addEvent: c, extend: u, fireEvent: m, isNumber: g, merge: f, pick: x } = l, { colorFromPoint: y, getContext: C } = a;
        class b extends d {
          constructor() {
          ...
          drawPoints() {
            ...
            if (s3) {
              ...
              if (!e4 || t3.isDirtyData || t3.isDirtyCanvas) {
                ...
                if (n3 && l3 && m2) {
                  let { min: m3, max: g2 } = i3.getExtremes(), { min: f2, max: x2 } = o2.getExtremes(), C2 = g2 - m3, b2 = x2 - f2, v = Math.round(C2 / d2 / 8 * 8), A = Math.round(b2 / p2 / 8 * 8), [M, w] = [[v, v / C2, r2, "ceil"], [A, A / b2, !a2, "floor"]].map(([t4, e5, s5, i4]) => s5 ? (s6) => Math[i4](t4 - e5 * s6) : (t5) => Math[i4](e5 * t5)), L = n3.width = v + 1, k = L * (n3.height = A + 1), S = (u2 - 1) / k, I = new Uint8ClampedArray(4 * k), D = (t4, e5) => 4 * Math.ceil(L * w(e5 - f2) + M(t4 - m3));
                  t3.buildKDTree();
          ...
          getExtremes() {
            ...
            return g(t3) && (this.valueMin = t3), g(e3) && (this.valueMax = e3), n.prototype.getExtremes.call(this);
          }
          ...
          init() {
            ...
            let t3 = this.options;
            t3.pointRange = x(t3.pointRange, t3.colsize || 1), this.yAxis.axisPointRange = t3.rowsize || 1, p.ellipse = p.circle, t3.marker && g(t3.borderRadius) && (t3.marker.r = t3.borderRadius);
          }
          markerAttribs(t3, e3) {
            let s3 = t3.shapeArgs || {};
          ...
          pointAttribs(e3, s3) {
            ...
            if (i2.stroke = e3 && e3.marker && e3.marker.lineColor || o2.marker && o2.marker.lineColor || h2 || this.color, i2["stroke-width"] = d2, s3 && "normal" !== s3) {
              let r3 = f(o2.states && o2.states[s3], o2.marker && o2.marker.states && o2.marker.states[s3], e3 && e3.options.states && e3.options.states[s3] || {});
          ...
          translate() {
            ...
            for (let e4 of (this.generatePoints(), this.points)) {
              ...
              e4.hasImage && (e4.marker = { width: n2, height: h2 }), e4.plotX = e4.clientX = (r2.x1 + r2.x2) / 2, e4.plotY = (r2.y1 + r2.y2) / 2, e4.shapeType = "path", e4.shapeArgs = f(true, { x: l2, y: a2, width: n2, height: h2 }, { d: p[i2](l2, a2, n2, h2, { r: g(t3) ? t3 : 0 }) });
            }
