    ...
    */
    function(t) {
      ...
      e(o, "Series/FlowMap/FlowMapPoint.js", [o["Core/Series/SeriesRegistry.js"], o["Core/Utilities.js"]], function(t2, o2) {
        ...
        return g.defaultOptions = m(n.defaultOptions, { animation: true, dataLabels: { enabled: false }, fillOpacity: 0.5, markerEnd: { enabled: true, height: "40%", width: "40%", markerType: "arrow" }, width: 1, maxWidth: 25, minWidth: 5, lineWidth: void 0, tooltip: { headerFormat: '<span style="font-size: 0.8em">{series.name}</span><br/>', pointFormat: "{point.options.from} → {point.options.to}: <b>{point.options.weight}</b>" } }), f(g.prototype, { pointClass: t2, pointArrayMap: ["from", "to", "weight"], drawPoints: s.prototype.drawPoints, useMapGeometry: true }), o2.registerSeriesType("flowmap", g), g;
