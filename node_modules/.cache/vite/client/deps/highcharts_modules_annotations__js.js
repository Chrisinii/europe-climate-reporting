      ...
      s(i, "Extensions/Annotations/AnnotationChart.js", [i["Core/Utilities.js"]], function(t2) {
        ...
        class E extends p {
          ...
          update(t3, i3) {
            ...
            n2.labels = e2.labels, n2.shapes = e2.shapes, this.destroy(), this.initProperties(s3, n2), this.init(s3, n2), s3.options.annotations[o2] = n2, this.isUpdating = true, y(i3, true) && s3.drawAnnotations(), b(this, "afterUpdate"), this.isUpdating = false;
          }
        }
