    ...
    */
    function(t) {
      ...
      s(i, "Extensions/Annotations/AnnotationChart.js", [i["Core/Utilities.js"]], function(t2) {
        ...
        function l(t3) {
          this.popup || (this.popup = new i2(this.chart.container, this.chart.options.navigation.iconsURL || this.chart.options.stockTools && this.chart.options.stockTools.gui.iconsURL || "https://code.highcharts.com/11.4.6/gfx/stock-icons/", this.chart)), this.popup.showForm(t3.formType, this.chart, t3.options, t3.onSubmit);
        }
        function h(t3, i3) {
        ...
        class C extends c {
          ...
          update(t3, i3) {
            ...
            o2.labels = n2.labels, o2.shapes = n2.shapes, this.destroy(), this.initProperties(s3, o2), this.init(s3, o2), s3.options.annotations[e2] = o2, this.isUpdating = true, b(i3, true) && s3.drawAnnotations(), m(this, "afterUpdate"), this.isUpdating = false;
          }
        }
