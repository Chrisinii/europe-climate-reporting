    ...
    function(t) {
      ...
      i(e, "Series/ArcDiagram/ArcDiagramPoint.js", [e["Series/NodesComposition.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function(t2, e2, i2) {
        ...
        function r(t3, i3, r2, o2, a2) {
          let n = [];
          if (a2) {
            let h = a2.start || 0, l = s(a2.r, r2), d = s(a2.r, o2 || r2), p = 2e-4 / Math.max(l, 1), c = Math.abs((a2.end || 0) - h - 2 * Math.PI) < p, u = (a2.end || 0) - p, g = a2.innerR, f = s(a2.open, c), m = Math.cos(h), y = Math.sin(h), x = Math.cos(u), b = Math.sin(u), S = s(a2.longArc, u - h - Math.PI < p ? 0 : 1), v = ["A", l, d, 0, S, s(a2.clockwise, 1), t3 + l * x, i3 + d * b];
