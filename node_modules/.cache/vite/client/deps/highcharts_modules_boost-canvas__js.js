      ...
      i(e, "Extensions/Boost/Boostables.js", [], function() {
        ...
        function V(e3) {
          ...
          if (k(this.chart) && t2[this.type]) {
            let t3 = this.is("scatter") && !this.is("bubble");
