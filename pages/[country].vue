    ...
    <div class="relative flex items-center justify-center w-full" style="height: calc(100vh - 100px);">
      ...
      <div class="flex items-center mr-2">
        <fa :icon="['fas', 'caret-left']"
            ...
            :class="currentArticleIndex > 0 ? 'text-green' : 'text-transparent cursor-not-allowed'"
            @click="currentArticleIndex > 0 && previousArticle()" />
      </div>
      ...
      <div v-if="currentArticleIndex < articleData.length - 1" class="flex items-center ml-2">
        <fa :icon="['fas', 'caret-right']" class="text-3xl cursor-pointer text-green" @click="nextArticle" />
      </div>
    </div>
